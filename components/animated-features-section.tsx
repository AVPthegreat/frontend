    ...
    <section id="features" className="py-20 px-4 bg-black">
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-8xl font-bold text-white mb-4" style={{ fontFamily: "var(--font-playfair)" }}>
            FEATURES
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Everything you need to take your coding journey to the next level
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="Beat Your Friends, Earn Rewards"
              subtitle="Level up your coding journey with XP, ranks, and badges.
                        Earn rewards for solving problems, maintaining streaks, and winning contests.
                       Climb the leaderboards, showcase your skills, and stay motivated to improve every day."
          ...
          <BentoCard
            title=""
            value="Code the Way You Want"
            subtitle="Pick languages, difficulty, and formats. Save custom presets for quick access. Customize your coding journey to your liking."
            colors={["#151515", "#252525", "#1d1d1d"]}
            delay={0.4}
          />
          <BentoCard
            title="Contests & Challenges"
            value="Weekly Contest"
            subtitle="Participate in weekly contests and challenges and Win cash prizes."
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="Compete Head-to-Head"
              subtitle="Challenge friends, family, or strangers to coding battles. Compete in timed challenges, solve problems together, and see who comes out on top."
          ...
          <div className="md:col-span-3">
            <BentoCard
              title="AI Mentoring"
              value="AI mentor & feedback system for personalized growth"
              subtitle="Get personalized feedback on your code, improve your skills, and get better at coding."
